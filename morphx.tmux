...
tmux_set status-left "#[fg=$G03,bg=$TC] $user_icon #U@#{hostname_short} #[fg=$TC,bg=$G06,nobold]$right_arrow_icon#[fg=$TC,bg=$G06] $session_icon #I #[fg=$G06,bg=$BG]$right_arrow_icon #{prefix_highlight}"

# Right side of status bar
#tmux_set status-right-bg "$G02"
#tmux_set status-right-fg "$G12"
tmux_set status-right-length 150
tmux_set status-right "#[fg=$G06,bg=$BG]$left_arrow_icon#[fg=$TC,bg=$G06] $time_icon $time_format #[fg=$TC,bg=$G06]$left_arrow_icon#[fg=$G02,bg=$TC] $date_icon $date_format "
